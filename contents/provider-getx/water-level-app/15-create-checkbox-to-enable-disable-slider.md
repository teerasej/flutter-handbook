# สร้าง checkbox เพื่อใช้เปิดปิดการทำงานของ Slider

## 1. สร้างตัวแปรเพื่อเก็บค่า checkbox
...
class GateCalculatorController extends GetxController {
  ...
  // สร้างตัวแปรเพื่อเก็บค่า checkbox
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                // นำ Row widget มาใส่เป็นตัวจัดกลุ่ม checkbox กับชื่อ Unit
                Row(
                  children: [
                    Checkbox(
                      // คำค่าตัวแปร u1Enabled จาก controller มากำหนดให้กับ checkbox
                      value: controller.u1Enabled.value,

                      // เมื่อมีการเปลี่ยนค่า checkbox ให้กำหนดค่าใหม่ให้กับตัวแปร u1Enabled ใน controller
                      onChanged: (bool? value) {
                        controller.u1Enabled.value = value!;
                      },
                    ),

                    // ชื่อ Unit ย้ายมาอยู่ใน Row widget ซึ่งการเรียงแบบนี้จะทำให้ข้อความอยู่ถัดมาทางขวาของ checkbox
                ...
                Slider(
                  ...
                  // กำหนดให้ slider สามารถใช้งานได้หาก checkbox ถูกเลือก หรือ u1Enabled == true
